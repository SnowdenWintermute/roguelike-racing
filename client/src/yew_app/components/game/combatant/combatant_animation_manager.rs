use crate::yew_app::components::game::combatant::process_next_action_result_in_combatant_event_queue::process_next_action_result_in_combatant_event_queue;
use crate::yew_app::components::game::combatant::process_next_animation_in_combatant_animation_queue::process_next_animation_in_combatant_animation_queue;
