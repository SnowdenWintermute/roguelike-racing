...
use crate::yew_app::components::lobby::game_setup::character_and_party_selection::CharacterAndPartySelection;
use crate::yew_app::components::lobby::game_setup::game_setup_menu::GameSetupMenu;
use crate::yew_app::components::lobby::user_list::UserList;

#[function_component(GameSetup)]
pub fn game_setup() -> Html {
    html!(
        <main class="min-h-screen w-screen flex justify-center">
