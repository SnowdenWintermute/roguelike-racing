pub fn apply_elemental_affinity_to_hp_change_range(
    affinity_as_percentage: i16,
    min_damage: f32,
    max_damage: f32,
) -> (f32, f32) {
    let damage_multiplier = if affinity_as_percentage < 0 {
    ...
    (
        damage_multiplier * min_damage,
        damage_multiplier * max_damage,
    )
}
