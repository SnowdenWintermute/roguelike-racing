...
pub static TWO_HANDED_RANGED_WEAPONS_POSSIBLE_PREFIXES_AND_TIERS: Lazy<Vec<(PrefixTypes, u8)>> =
    Lazy::new(|| {
...
pub static TWO_HANDED_RANGED_WEAPONS_POSSIBLE_SUFFIXES_AND_TIERS: Lazy<Vec<(SuffixTypes, u8)>> =
    Lazy::new(|| {
